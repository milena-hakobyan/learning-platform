...
('instructor3', 'John', 'Doe', 'john@example.com', 'INSTRUCTOR', 'hash13', NOW()),
...
VALUES
('Java Assignment', 'Write a simple Java class', CURRENT_DATE + INTERVAL '5 days', 100, 1, 1),
('React Assignment', 'Create a React component', CURRENT_DATE + INTERVAL '7 days', 100, 2, 2),
('Python Assignment', 'Analyze data with Pandas', CURRENT_DATE + INTERVAL '6 days', 100, 3, 3),
('Docker Assignment', 'Build a Docker image', CURRENT_DATE + INTERVAL '8 days', 100, 4, 4),
('Flutter Assignment', 'Design a Flutter UI', CURRENT_DATE + INTERVAL '9 days', 100, 5, 5),
('Advanced Java Assignment', 'Implement Java Streams', CURRENT_DATE + INTERVAL '10 days', 100, 6, 6),
('CSS Assignment', 'Create a Flexbox layout', CURRENT_DATE + INTERVAL '4 days', 100, 7, 7),
('ML Assignment', 'Train a simple model', CURRENT_DATE + INTERVAL '11 days', 100, 8, 8),
('Kubernetes Assignment', 'Deploy an app on K8s', CURRENT_DATE + INTERVAL '12 days', 100, 9, 9),
('Dart Assignment', 'Write Dart functions', CURRENT_DATE + INTERVAL '3 days', 100, 10, 10);
